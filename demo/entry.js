...
var ActionView = function (_Inferno$Component) {
    ...
    function ActionView(props) {
        ...
        var _this = _possibleConstructorReturn(this, (ActionView.__proto__ || Object.getPrototypeOf(ActionView)).call(this, props));
        ...
        value: function render() {
            ...
            return createVNode(2, 'div', 'card', [createVNode(2, 'button', null, 'X', {
                'onClick': function onClick(e) {
                    return _this2.props.removeAction();
                }
            }), createVNode(2, 'button', null, 'E', {
                'onClick': function onClick(e) {
                    return _this2.setState({ editing: true });
                }
            }), createVNode(2, 'div', 'clearing'), createVNode(2, 'p', null, ['Key: ', createVNode(2, 'strong', null, this.props.action.key)]), createVNode(2, 'p', null, ['Conditions:', createVNode(2, 'ul', null, conditions), 'Effects:', createVNode(2, 'ul', null, effects)]), this.state.editing ? createVNode(16, ActionEditor, null, null, {
...
var ActionEditor = function (_Inferno$Component2) {
    _inherits(ActionEditor, _Inferno$Component2);

    function ActionEditor(props) {
        _classCallCheck(this, ActionEditor);

        var _this3 = _possibleConstructorReturn(this, (ActionEditor.__proto__ || Object.getPrototypeOf(ActionEditor)).call(this, props));
        ...
        _this3.save = function () {
            ...
            // validate conditions
            var newConditions = {};
            var conditionNodes = Array.from(document.getElementsByClassName('actionConditionsEditorForm')[0].getElementsByTagName('input'));
            var _loop = function _loop(i) {
                ...
                conditionNodes.forEach(function (node) {
                    ...
                    if (nodeName == 'condition' + i + 'val') {
                        cVal = _this3.convertIfBool(node.value);
                    }
            ...
            // validate effects
            var newEffects = {};
            var effectNodes = Array.from(document.getElementsByClassName('actionEffectsEditorForm')[0].getElementsByTagName('input'));
            var _loop2 = function _loop2(i) {
                var eKeyNode = void 0,
                    eKey = void 0,
                    eVal = void 0;

                effectNodes.forEach(function (node) {
                    var nodeName = node.getAttribute('name');

                    if (nodeName == 'effect' + i + 'val') {
                        eVal = _this3.convertIfBool(node.value);
                    }
                    if (nodeName == 'effect' + i + 'key') {
                        eKeyNode = node;
                        eKey = node.value;
                    }
                });

                if (!variableValidator.test(eKey)) {
                    passesValidation = false;
                    console.log('effect key "' + eKey + '" is not valid');
                    if (!eKeyNode.classList.contains('invalid')) {
                        eKeyNode.classList.add('invalid');
                    }
                } else {
                    if (eKeyNode.classList.contains('invalid')) {
                        eKeyNode.classList.remove('invalid');
                    }
                }

                if (typeof eKey !== 'undefined') {
                    newEffects[eKey] = eVal;
                }
            };

            for (var i = 0; i <= _this3.state.e; i++) {
                _loop2(i);
            }

            if (passesValidation) {
                _this3.props.action.key = _this3.state.actionKey;
                _this3.props.action.conditions = newConditions;
                _this3.props.action.effects = newEffects;
        ...
        _this3.effectChanged = function (e) {
            var effectDataNodes = Array.from(e.target.parentNode.getElementsByTagName('input'));
            var oldKey = void 0,
                effectsIdx = void 0;

            effectDataNodes.forEach(function (node) {
                if (node.getAttribute('name').indexOf('key') >= 0) {
                    oldKey = node.getAttribute('prevVal');
                    effectsIdx = _this3.indexOf2DArr(_this3.state.effects, 0, oldKey);
                }
            });

            effectDataNodes.map(function (node) {
                if (node.getAttribute('name').indexOf('val') >= 0) {
                    _this3.state.effects[effectsIdx][1] = node.value;
                }
                if (node.getAttribute('name').indexOf('key') >= 0) {
                    _this3.state.effects[effectsIdx][0] = node.value;
                    node.setAttribute('prevVal', node.value);
                }
            });
        };
        ...
        _this3.addBlankEffect = function (e) {
            _this3.state.effects.push(['newEffect' + _this3.state.n++, null]);
            _this3.setState();
        };

        _this3.keyChanged = function (e) {
            _this3.state.actionKey = e.target.value;
        };
        ...
        _this3.state = {
            ...
            conditions: Object.keys(props.action.conditions).map(function (key) {
                return [key, props.action.conditions[key]];
            }), effects: Object.keys(props.action.effects).map(function (key) {
                return [key, props.action.effects[key]];
            }) };return _this3;
    }

    _createClass(ActionEditor, [{
        key: 'convertIfBool',
        value: function convertIfBool(string) {
            if (string === 'true') {
                return true;
            }
            if (string === 'false') {
        ...
        value: function render() {
            ...
            this.state.e = -1;
            var effects = this.state.effects.map(function (kv) {
                _this4.state.e += 1;
                var key = kv[0];
                var val = kv[1];
                var en = _this4.state.e;
                return createVNode(2, 'div', 'editEffectRow', [createVNode(2, 'button', null, 'X', {
                    'type': 'button',
                    'onClick': function onClick(e) {
                        return _this4.removeEffect(key);
                    }
                }), createVNode(512, 'input', null, null, {
                    'type': 'text',
                    'onChange': function onChange(e) {
                        return _this4.effectChanged(e);
                    },
                    'name': 'effect' + en + 'key',
            ...
            return createVNode(2, 'div', 'overlay', createVNode(2, 'div', 'modal', [createVNode(2, 'div', 'modal-header', [createVNode(2, 'div', 'clearing'), createVNode(2, 'button', 'modal-close-btn', 'X', {
                ...
                'name': 'key',
                'placeholder': 'Key',
                'value': this.state.actionKey,
                'onChange': function onChange(e) {
                    return _this4.keyChanged(e);
                }
            })]), createVNode(2, 'br'), createVNode(2, 'p', null, 'Conditions:'), createVNode(2, 'form', 'actionConditionsEditorForm', conditions, {
                'onSubmit': function onSubmit(e) {
                    e.preventDefault(), _this4.save();
                }
            }), createVNode(2, 'button', null, 'Add New Condition', {
                'onClick': this.addBlankCondition
            }), createVNode(2, 'p', null, 'Effects:'), createVNode(2, 'form', 'actionEffectsEditorForm', effects, {
                'onSubmit': function onSubmit(e) {
                    e.preventDefault(), _this4.save();
                }
            }), createVNode(2, 'button', null, 'Add New Effect', {
                'onClick': this.addBlankEffect
                ...
                'onClick': function onClick(e) {
                    return document.getElementsByClassName('actionConditionsEditorForm')[0].dispatchEvent(new CustomEvent('submit', { bubbles: true, cancelable: true }));
                }
            })])]));
        }
    }]);
...
},{"./action.js":1,"./goal.js":3}],3:[function(require,module,exports){
'use strict';
...
var GoalEditor = function (_Inferno$Component2) {
    ...
    function GoalEditor(props) {
        ...
        _this3.save = function () {
            ...
            // validate conditions
            var newConditions = {};
            var conditionNodes = Array.from(document.getElementsByClassName('goalConditionsEditorForm')[0].getElementsByTagName('input'));
            var _loop = function _loop(i) {
                var cKeyNode = void 0,
                    cKey = void 0,
                    cVal = void 0;
    ...
    _createClass(GoalEditor, [{
        ...
        value: function render() {
            ...
            return createVNode(2, 'div', 'overlay', createVNode(2, 'div', 'modal', [createVNode(2, 'div', 'modal-header', [createVNode(2, 'div', 'clearing'), createVNode(2, 'button', 'modal-close-btn', 'X', {
            ...
            })]), createVNode(2, 'p', null, 'Conditions:'), createVNode(2, 'form', 'goalConditionsEditorForm', conditions, {
                'onSubmit': function onSubmit(e) {
                    e.preventDefault(), _this4.save();
                }
            }), createVNode(2, 'button', null, 'Add New Condition', {
                ...
                'onClick': function onClick(e) {
                    return document.getElementsByClassName('goalConditionsEditorForm')[0].dispatchEvent(new CustomEvent('submit', { bubbles: true, cancelable: true }));
                }
            })])]));
        }
    }]);
